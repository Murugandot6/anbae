    ...
    <div className="grid grid-cols-5 sm:grid-cols-6 md:grid-cols-7 lg:grid-cols-8 gap-3 p-4 rounded-md border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
      {avatarPaths.map((path) => {
        ...
        return (
          ...
          >
            <Avatar className="w-14 h-14 sm:w-16 sm:h-16 md:w-18 md:h-18 lg:w-20 lg:h-20 aspect-square rounded-full overflow-hidden block flex-shrink-0 border-2 border-red-500"> {/* Added aspect-square, explicit rounded-full/overflow-hidden, block, flex-shrink-0, and red border for debugging */}
