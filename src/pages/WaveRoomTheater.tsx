          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-baseline gap-3">
                ...
                <div className="flex items-center gap-2 bg-gray-700/50 rounded-md p-2 border border-gray-600">
                    <span className="font-mono text-lg text-indigo-300">{room.room_code}</span>
                    <Button onClick={handleCopyCode} variant="ghost" size="icon" className="w-6 h-6 text-gray-300 hover:text-white">
