      ...
      <div className="h-screen w-screen bg-background text-foreground flex flex-col antialiased">
        <header className="bg-transparent backdrop-blur-md p-4 z-20 sticky top-0">
          <div className="container mx-auto flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <Button onClick={handleLeaveRoom} variant="destructive" size="icon" className="w-10 h-10 bg-destructive hover:bg-destructive/90 text-destructive-foreground rounded-full shadow-md">
        ...
        <main className="flex-grow overflow-y-auto pb-32">
          <div className="container mx-auto p-4 md:p-6">
            ...
            <SearchBar onSearch={setSearchQuery} isLoading={isStationsLoading} initialQuery={searchQuery} onClear={() => setSearchQuery('')} className="mb-8" />
            <StationList
              stations={stations}
